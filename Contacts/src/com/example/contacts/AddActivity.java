...
public class AddActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		sd.execSQL("create table if not exists contact_info(contactid integer primary key autoincrement,name varchar(30),contact_no varchar(10),emailid varchar(45),address varchar(100))");
